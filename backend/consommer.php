...
switch ($_SERVER['REQUEST_METHOD']) {
  ...
  case 'GET':
    ...
    if (!isset($_GET['login']) || !isset($_GET['date_consommation'])) {
      ...
      $sql = "SELECT ID_ALIMENT,QUANTITE,ID_CONSOMMATION,DATE_CONSOMMATION FROM CONSOMMER WHERE LOGIN = '" . $login . "' AND DATE_CONSOMMATION > '" . $date_consommation . "'";
  ...
  case 'PUT':
    ...
    if (!isset($data->id_consommation)) {
      ...
      $sql = "UPDATE CONSOMMER
              SET DATE_CONSOMMATION = $date_consommation, QUANTITE = $quantite
