<div class="navbar">
  ...
  ?>
  <form method="GET">
    <button id="navbar_button_page_journal" type="submit" class="nav-button inactive-nav-button">
  ...
  <form method="GET">
    <button id="navbar_button_page_track_food" type="submit" class="nav-button inactive-nav-button">
  ...
  <form method="GET">
    <button id="navbar_button_page_profile" type="submit" class="nav-button inactive-nav-button">
  ...
  <form method="GET">
    <button id="navbar_button_page_dish" type="submit" class="nav-button inactive-nav-button">
  ...
  <form method="GET">
    <button type="submit" class="nav-button inactive-nav-button">
...
<script>
  ...
  if (actualPage) {
    ...
    actualPage.classList.remove("inactive-nav-button");
  }
</script>